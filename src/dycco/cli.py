...
def do_main(paths, output_dir, use_ascii: bool, escape_html: bool, single_file: bool):
    try:
...
def main():
    ...
    return do_main(args.source_file, args.output_dir, args.use_ascii, args.escape_html, args.single_file)
